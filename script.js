document.addEventListener("DOMContentLoaded", () => {
    ...
    const deliveryFeeLineElem = document.querySelector(".delivery-fee-line");
    ...
    const TAXA_ENTREGA = 8.0; // ajuste este valor conforme a região/negócio
    ...
    if (pickupDateInput) {
        ...
        pickupDateInput.min = `${ano}-${mes}-${dia}`;
    }
    ...
    const produtos = [
        ...
        },
        {
            ...
            categoria: "massas",
            preco: 39.9,
            imagem: "https://images.unsplash.com/photo-1619895092538-128341789043?w=400",
            descricao: "Camadas de massa, molho e queijo gratinado",
        },
        {
            id: 3,
            ...
            descricao: "Pão brioche, hambúrguer e molho especial",
        },
        {
            id: 4,
            ...
            categoria: "massas",
            preco: 35.9,
            imagem: "https://images.unsplash.com/photo-1473093295043-cdd812d0e601?w=400",
            descricao: "Creme rico com cogumelos salteados",
        },
        {
            id: 5,
            ...
            descricao: "Camada intensa de chocolate e creme",
        },
        {
            id: 6,
            nome: "Pão de Alho",
            categoria: "lanches",
            preco: 15.9,
            imagem: "https://images.unsplash.com/photo-1509440159596-0249088772ff?w=400",
            descricao: "Quentinho e servido com manteiga aromatizada",
        },
        {
            id: 7,
            nome: "Panna Cotta",
        ...
        },
        {
            ...
            descricao: "Escolha sua soda em sabores especiais",
        },
        {
            id: 9,
            ...
            preco: 45.9,
            imagem: "https://images.unsplash.com/photo-1513104890138-7c749659a591?w=400",
            descricao: "Pepperoni, molho e queijo derretido",
        },
        {
            id: 10,
            nome: "Cappuccino",
            categoria: "bebidas",
            preco: 14.9,
            imagem: "https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=400",
        ...
        if (produtosFiltrados.length === 0) {
            container.innerHTML = `
                        <div style="grid-column: 1 / -1; text-align: center; padding: 3rem; color: #999;">
                            ...
                            <p style="font-size: 1.2rem; font-weight: 600;">Nenhum prato encontrado</p>
                        </div>
                    `;
        } else {
    ...
    const atualizarCarrinho = () => {
        if (carrinho.length === 0) {
            cartBody.innerHTML = `<div class="cart-empty"><i class="fa-solid fa-box-open"></i><p>Seu pedido está vazio.</p></div>`;
        } else {
            cartBody.innerHTML = carrinho
                .map(
                    (item) =>
                        `<div class="cart-item" data-id="${item.id}"><img src="${item.imagem}" alt="${item.nome}" class="cart-item-img" loading="lazy"><div class="cart-item-info"><h4 class="cart-item-name">${item.nome}</h4><p class="cart-item-price">${formatarMoeda(item.preco)}</p><div class="cart-item-controls"><button class="quantity-btn" data-action="diminuir">-</button><span class="quantity">${item.quantidade}</span><button class="quantity-btn" data-action="aumentar">+</button></div></div><button class="remove-item-btn">&times;</button></div>`,
                )
                .join("");
        }
        ...
        const taxaEntrega =
            tipoEntrega === "delivery" && carrinho.length > 0 ? TAXA_ENTREGA : 0;
        ...
        if (taxaEntrega > 0) {
            deliveryFeeElem.textContent = formatarMoeda(taxaEntrega);
    ...
    const finalizarPedido = () => {
        ...
        const numeroWhatsApp = "5594984057908";
        ...
        const total = subtotal - discountAmount + taxaEntrega;
        let mensagem = `*-- NOVO PEDIDO Trindade Restaurante --*\n\n*Itens:*\n${itensPedido}\n\n*Subtotal:* ${formatarMoeda(subtotal)}${cupomInfo}${taxaInfo}\n*Total:* ${formatarMoeda(total)}\n\n-------------------------\n\n`;
